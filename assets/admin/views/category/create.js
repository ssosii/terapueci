        ...
        <Fragment>
            ...
            <Formik
                ...
                onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                    ...
                    const [fetch] = useApi();
                    fetch('/admin/api-create-category', { name,type }, 'post')
                        .then((response) => {
                            console.log("response", response);
...
const el = document.querySelector('#createCategory');
const type = el.dataset.type;

render(<CreateDoctor type={type} />, document.querySelector('#createCategory'));
