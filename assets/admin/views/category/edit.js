...
const EditDoctor = ({ categoryID }) => {
    ...
    useEffect(() => {
        ...
        const [fetch] = useApi();
        fetch(`/admin/category-init-data-edit/${categoryID}`, 'post')
            .then((response) => {
            ...
            {!initialData ? (
                ...
                <Formik
                    ...
                    onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                        ...
                        fetch(`/admin/update-category/${categoryID}`, { name }, 'post')
                            .then((response) => {
                                console.log("response", response);
                                setInitialData(response.name);
...
const el = document.querySelector('#editCategory');
const categoryID = el.dataset.id;


render(<EditDoctor categoryID={categoryID} />, el);
